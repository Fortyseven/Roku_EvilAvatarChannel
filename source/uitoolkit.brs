...
' **
' **  Modified 2010-10, Toby Deshane:
' **	- Added 'selected' argument to uitkDoPosterMenu to
' **      optionally choose which item to have selected on
' **      display.
' **
' *********************************************************
' *********************************************************
...
function uitkPreShowPosterMenu(breadA=invalid, breadB=invalid, style="arced-landscape") As Object
...
function uitkDoPosterMenu(posterdata, screen, selected = 0, onselect_callback=invalid) As Integer
	...
	screen.SetFocusedListItem( selected )
